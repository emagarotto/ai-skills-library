...
Paste the **Skill Instructions** section below into the Instructions field of a Custom GPT or a ChatGPT Project. Enable Web Search under Capabilities. Then fill in the `[YOUR INFO]` placeholders in the About You section with your own details before saving.
...
> **Note:** Google Drive template cloning, HTML widget rendering, and LinkedIn auto-fill require Claude Code. This version outputs all content directly in the chat for you to copy and paste into your templates manually.
...
Wait for the answer. Use it throughout to frame the cover letter and resume summary appropriately. If only one role type applies, skip this step.
